...
for(var i=0;i<tags.length;i++) {
	...
	for (var j = 0; j < countValStr; j++) {
		//tmpTag+=tags[i]+'\n'
		if(j==0)
			tmpTag +="<div id='adTag"+ i +"sub"+ j +"' style='margin-top:20px;display:inline;border:1px solid #000000;float:left'>" + tags[i] + "</div><textarea id='adTagTxt"+ i +"' style='float:right;display:block;max-height:300px;max-width:500px;height:300px;width:500px;border:2px solid #8585ff;'></textarea><h4 style='float:right;clear:both;margin-left:10px;margin-bottom:10px;margin-left:0px;display:table-cell'>Call Flow :</h4><div style='clear:both;margin-top:35px;height:300px;width:1300px;margin-left:0px;overflow-y: scroll; overflow-x:hidden;background-color:#efefef;border:2px solid #8585ff;border-radius:10px;word-wrap: break-word;' id='adTagdiv"+ i + "sub" + j +"'></div>"
		else
